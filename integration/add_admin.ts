...
async function addAdmin() {
	...
	const newAdminAddress = '0xbbb95be5282519238e7576099a40a794702303ad114e1ee2a5f25e9001d901a5';

	if (!packageId || !gasStationId || !privateKeyBase64 || !newAdminAddress) {
		throw new Error(
			"Missing required env vars: PACKAGE_ID, GAS_STATION_ID, PRIVATE_KEY, NEW_ADMIN_ADDRESS"
		);
	}
	...
	tx.moveCall({
		target: `${packageId}::gas_station::add_admin`,
		arguments: [
